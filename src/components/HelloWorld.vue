<template>
  <div class="hello">
    ...
    This is the output: <span v-text="input_val"></span>
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      msg: 'Welcome to Your Vue.js App (Oh, it has been modified)',
      users: [
        {uid: 1, firstname: 'Sebastian', lastname: 'Eschweiler'},
        {uid: 2, firstname: 'Bill', lastname: 'Smith'},
